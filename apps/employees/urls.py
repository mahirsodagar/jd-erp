...
urlpatterns = [
    ...
    path("<int:pk>/documents/", EmployeeDocumentListCreateView.as_view(), name="employee-documents"),
    path("<int:pk>/documents/<int:doc_id>/", EmployeeDocumentDetailView.as_view(), name="employee-document-detail"),
