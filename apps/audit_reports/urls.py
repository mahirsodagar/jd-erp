...
from .views import (
    ...
    FacultySelfAppraisalDetailView,
...
urlpatterns = [
    ...
    path("course-end/<int:pk>/", CourseEndReportDetailView.as_view(),
         name="course-end-detail"),

    path("batch-mentor/", BatchMentorReportListCreateView.as_view(),
         name="batch-mentor-list-create"),
    path("batch-mentor/<int:pk>/", BatchMentorReportDetailView.as_view(),
         name="batch-mentor-detail"),
    ...
    path("feedback/<int:pk>/", StudentFeedbackDetailView.as_view(),
    ...
    path("self-appraisal/<int:pk>/", FacultySelfAppraisalDetailView.as_view(),
         name="self-appraisal-detail"),
    ...
    path("compliance/<int:pk>/", ComplianceFlagDetailView.as_view(),
